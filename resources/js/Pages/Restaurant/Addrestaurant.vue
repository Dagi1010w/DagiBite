...
// Submit
function submit() {
  // Adjust route name to match your routes file (e.g., Route::post('/restaurants', ...)->name('restaurants.store'))
    form.post('/restaurants', {
      forceFormData: true, // ensure multipart for file upload
      onSuccess: () => {
        // Redirect to restaurant dashboard after successful creation
    ...
    <section class="min-h-screen bg-gradient-to-b from-orange-50/40 via-white to-white py-8">
      <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 text-center">
          ...
          <p class="mt-2 text-sm sm:text-base text-gray-600">Provide your restaurant details below.</p>
        </div>
              ...
              <div class="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="mt-1 w-full rounded-xl border border-orange-200/70 bg-white px-3 py-2.5 text-sm shadow-sm placeholder:text-gray-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-200"
                  />
                  <p class="mt-1 text-xs text-gray-500">Used in your public URL. Only letters, numbers, and hyphens.</p>
              ...
              <div class="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="mt-1 w-full rounded-xl border border-orange-200/70 bg-white px-3 py-2.5 text-sm shadow-sm placeholder:text-gray-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-200"
                  />
                  <p class="mt-1 text-xs text-gray-500">Optional. You can leave 0 and let it be computed by reviews later.</p>
              ...
              <div class="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    class="mt-1 w-full rounded-xl border border-orange-200/70 bg-white px-3 py-2.5 text-sm shadow-sm placeholder:text-gray-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-200"
                  />
                  <p class="mt-1 text-xs text-gray-500">Must be unique. Include country code if applicable.</p>
